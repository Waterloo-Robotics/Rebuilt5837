...
public class RotateTravelCommand extends Command {
 @SuppressWarnings("PMD.UnusedPrivateField")
   ...
   */
  public RotateTravelCommand(IntakeSubsystem isubsystem,RotateSubsystem rsubsystem) {
